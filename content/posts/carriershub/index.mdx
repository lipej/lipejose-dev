...
**OBS: esse artigo foi originalmente escrito no livebook, toda a saida de código foi guardada abaixo de seu respectivo bloco de código, basta clicar em "output".**
...
Pronto! como é possivel ver no output, estamos conseguindo consultar codigos nos correio.
